  ...
  return (
    <FooterBox>
      <Contents>
        ...
        <TextBox>
          <div>상호: 비너스치과 의원</div>
          <div>주소: 서울특별시 강남구 논현로 841, JB미소빌딩 B105호</div>
          <div>Copyright (C) Venuss Dental Clinic. All right reserved.</div>
        </TextBox>
        <TextBox>
          <div>Tel: 02-3445-9716</div>
          <div>사업자 등록번호 000-00-0000</div>
        </TextBox>
      </Contents>
      <MContents>
        <MLogoBox />
