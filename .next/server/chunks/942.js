...
const Navigator = () => {
  ...
  })(["display:flex;border-bottom:1px solid #4a4e69;width:calc(100vw - 25%);", " ", " ", ""], ({
    theme
  }) => theme.desktop`
        width: calc(100vw - 60%);
    `, ({
  ...
  })(["font-size:25px;display:table;width:100%;", " ", " ", ""], ({
    theme
  }) => theme.laptop`
  ...
  })(["display:table-cell;width:16.666666667%;line-height:87px;text-align:center;white-space:nowrap;"]);
