...
const Navigator = () => {
  ...
  })(["width:100%;display:flex;align-items:center;justify-content:center;padding-top:15px;font-size:25px;font-weight:400;margin-left:20px;", " ", ""], ({
    theme
  }) => theme.laptop`
  ...
  })(["text-align:center;&._12{width:12%;margin:20px;}&._20{width:20%;}&._25{width:25%;margin-right:20px;}&:last-child{margin:0;}", ""], ({
    theme
  }) => theme.laptop`
     &._12 {
      width: 12%;
  ...
  })(["width:100%;margin:0px 0px 75px 40px;"]);
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(VNavi, {
    ...
    }), /*#__PURE__*/jsx_runtime_.jsx(NaviBox, {
...
const Footer = props => {
  ...
  })(["display:flex;align-items:center;justify-items:center;justify-content:center;width:calc(100% - 400px);", " ", ""], ({
    theme
  }) => theme.mobile`
     width: 100%;
     display: none;
  ...
  })(["line-height:1.5;&:first-child{width:calc(100% - 300px);}&:nth-child(2){width:calc(100% - 700px);}", ""], ({
    theme
  }) => theme.laptop`
   &:first-child {
