...
const RightButton = () => {
  ...
  })(["position:fixed;top:200px;right:0;z-index:10;width:70px;height:70px;", " ", " ", ""], ({
    theme
  }) => theme.mobile`
  ...
  })(["display:flex;align-items:center;justify-content:center;width:100%;height:100%;margin-bottom:10px;box-shadow:0px 1px 2px #00000030;cursor:pointer;", " ", ""], props => {
    if (props.blog) {
  ...
  const YoutubeButton = external_styled_components_default().div.withConfig({
    ...
    theme
      ...
      height: 30px;
    `);
  const LoginButton = external_styled_components_default().div.withConfig({
    displayName: "RightButton__LoginButton",
    componentId: "sc-1009g4l-4"
  })([""]);
  const TopButton = external_styled_components_default().div.withConfig({
    displayName: "RightButton__TopButton",
    componentId: "sc-1009g4l-5"
  })(["margin-top:2px;color:", ";font-size:25px;"], props => props.theme.lightBeige);
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
    children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)(RightButtonBox, {
    ...
    }), /*#__PURE__*/jsx_runtime_.jsx(RightButtonBox, {
      round: true,
      children: /*#__PURE__*/jsx_runtime_.jsx(Button, {
        top: true,
        children: /*#__PURE__*/jsx_runtime_.jsx(TopButton, {
          onClick: e => {
            e.preventDefault();
            window.scrollTo({
              top: 0,
...
const LoginButton = () => {
  const ButtonBox = external_styled_components_default().div.withConfig({
    displayName: "LoginButton__ButtonBox",
    componentId: "sc-1xxg4fx-0"
  })(["position:absolute;top:10px;left:10px;color:transparent;&:hover{color:", ";cursor:pointer;}"], props => props.theme.darkestSpace);
...
const AppLayout = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(VLayout, {
    children: [/*#__PURE__*/jsx_runtime_.jsx(components_LoginButton, {}), /*#__PURE__*/jsx_runtime_.jsx(VBox, {
